            ...
            <div className="book-content__box">
              ...
              <form className="box-form">
                <div className="box-form__car-type">
                  <label>
                    <i className="fa-solid fa-motorcycle"></i> &nbsp; Select
                    Your Scooter Model <b>*</b>
                  </label>
                ...
                <div className="box-form__car-type">
                  <label>
                    <i className="fa-solid fa-palette"></i> &nbsp; Choose your
                    colour <b>*</b>
                  </label>
                ...
                <div className="box-form__car-type">
                  <label>
                    <i className="fa-solid fa-road"></i> &nbsp; Landmark{" "}
                    <b>*</b>
                  </label>
                  <input
                    type="text"
                ...
                <div className="box-form__car-type">
                  <label>
                    <i className="fa-solid fa-rupee-sign"></i> &nbsp; Booking
                    Amount <b>*</b>
                  </label>
                  <input
                    type="number"
